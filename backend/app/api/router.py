...
from app.api.v1 import auth, portfolios, training, market, metrics, experiments, strategies, users, backtests, benchmarks, telemetry
...
api_router.include_router(benchmarks.router, tags=["benchmarks"], prefix="/benchmarks")
api_router.include_router(telemetry.router, tags=["telemetry"], prefix="/telemetry")
